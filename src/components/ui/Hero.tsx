...
export default function Hero() {
  return (
    <div className="flex w-full bg-[url(/landing/hero.png)] bg-cover bg-center text-white fixed top-0 left-0 h-screen z-10">
      <div className="absolute left-0 top-0 h-full w-full bg-gradient-to-r from-black/85 to-black/40 md:from-black/95 md:to-black/10"></div>

      <div className="flex flex-col w-full p-4 text-center sm:text-left max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col pt-20 pb-8 max-w-xl items-center sm:items-start">
          ...
          <h1 className="text-5xl lg:text-6xl mt-0 mb-6 font-sour-gummy font-semibold text-yellow-400 drop-shadow-[2px_2px_1px_#000000]">
            Creamos y aprendemos juntos
          </h1>
          <p className="text-xl sm:text-2xl text-lime-300 drop-shadow-[2px_2px_1px_#000000]">
        ...
        <div className="flex flex-col font-cutive-mono items-center sm:items-start">
          <Snippet
            ...
            variant="bordered"
            className="text-yellow-300 border-yellow-300 my-4 bg-black/40 text-md md:text-lg text-center w-fit drop-shadow-md"
          >
